...
$query = "SELECT * FROM `xssd_card_fee_status` ORDER BY create_time DESC ";
$result = mysqli_query($link, $query);
$arr = $result->fetch_all(MYSQLI_ASSOC);
mysqli_close($link);
$head = array('使用日期','工具名称','面额','使用张数','抵用券费用','对应投资金额','对应年化金额');
...
<div style="text-align: center" class="top">
    ...
    <span style="font-size:18px;color:#F44B2A;float:left;">抵用券费用及转化率</span>
</div>
<div class="search">
...
<script type="text/javascript">
    ...
    $("#download").click(function(){
        ...
        exportPlugin.downloadFile('csv', {filename: '抵用券费用及转化率'});
    })
