...
$query = "SELECT * FROM `xssd_clause_money`";
$result = mysqli_query($link, $query);
$arr = $result->fetch_all(MYSQLI_ASSOC);
mysqli_close($link);
$head = array('回款日期','账号类型','实际回款金额','回款人数','回款笔数','回款用户当天投资金额',
    '回款用户当天投资笔数','回款用户当天投资人数','金额复投率','回款用户当天提现金额','回款用户当天提现笔数','回款用户当天提现人数','提现复投率','回款用户账户余额');
...
<div style="text-align: center" class="top">
    ...
    <span style="font-size:18px;color:#F44B2A;float:left;">回款用户投资提现</span>
</div>
<div class="search">
...
<script type="text/javascript">
    ...
    $("#download").click(function(){
        ...
        exportPlugin.downloadFile('csv', {filename: '回款用户投资提现'});
    })
