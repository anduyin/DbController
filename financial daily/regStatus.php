...
$query = "SELECT * FROM `xssd_reg_status` ORDER BY create_time DESC ";
$result = mysqli_query($link, $query);
$arr = $result->fetch_all(MYSQLI_ASSOC);
mysqli_close($link);
$head = array('注册日期','推荐人','注册渠道','注册人数','注册当天实名人数','注册当天充值人数','注册当天充值金额','注册当天投资人数','注册当天投资金额','注册当天投资笔数','注册实名转化率','注册投资转化率');
...
<div style="text-align: center" class="top">
    ...
    <span style="font-size:18px;color:#F44B2A;float:left;">注册及转化数据</span>
</div>
<div class="search">
...
<script type="text/javascript">
    ...
    $("#download").click(function(){
        ...
        exportPlugin.downloadFile('csv', {filename: '注册及转化数据'});
    })
