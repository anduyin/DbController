...
mysqli_close($link);
$head = array('应还月份','阶段1_待收本金','阶段1_待收管理费','阶段2_待收本金','阶段2_待收管理费','存管_待收本金','存管_待收管理费','更新日期');
...
<div style="text-align: center" class="top">
    ...
    <span style="font-size:18px;color:#F44B2A;float:left;">待收按应还月份汇总</span>
</div>
<div class="search">
...
<script type="text/javascript">
    ...
    $("#download").click(function(){
        ...
        exportPlugin.downloadFile('csv', {filename: '待收按应还月份汇总'});
    })
