 ...
 *  */
	...
	$query1 = "select field from overdue_analysis_track_money_tg group by field";
	mysqli_query($link,'set names utf8');
	$result = mysqli_query($link, $query1);
	$arr1 = $result->fetch_all(MYSQLI_ASSOC);//查询所有field字段
	$query2 = "select * from overdue_analysis_track_money_tg where status_time= \"$statusTime\" and field= \"贷款名称\"";
...
<body style="background-color:#fff;">
	...
	<div style="text-align: center" class="top">
		...
		<form action="../download.php" method="post">
			...
			<a href="../overdue_analysis_track_num/oatn.php" class="href">笔数-回溯版</a>
			<a href="oatmPic.php" class="href">柱形图</a>
		</form>
	</div>
	<div id="t">
		<div class="title">
