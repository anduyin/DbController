...
$query = "SELECT * FROM `licai_monthly_recharge_carry` ORDER BY give_month DESC ";
$result = mysqli_query($link, $query);
$arr = $result->fetch_all(MYSQLI_ASSOC);
mysqli_close($link);
$head = array('ID','月份','申请充值笔数','申请充值金额','申请充值人数','成功充值笔数','成功充值金额','成功充值人数','申请提现笔数','申请提现金额','申请提现人数','成功提现笔数','成功提现金额','成功提现人数');
...
<body style="background-color:#fff;">
	...
	<div style="text-align: center" class="top">
        ...
        <span style="font-size:18px;color:#F44B2A;float:left;">充值提现金额</span>
    </div>
		<div class="search">
...
var hot = new Handsontable(container, {
	...
	$("#download").click(function(){
		...
		exportPlugin.downloadFile('csv', {filename: '充值提现金额'});
	})
</script>
</script>
</html>
