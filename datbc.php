...
$query1 = "select * from data_amount_to_be_collected where status_time = \"$status_time1\"";
...
<body>
	...
	<span style="font-size:18px;color:#262626;float:left;margin-left:25px;">财务></span>
        <span style="font-size:18px;color:#F44B2A;float:left;">利息金额</span>
	<!-- 时间选项 -->
	...
	<a href="datbcPic1.php">利息金额图</a>
	<a href="datbcPic2.php">逾期等级图</a>
	</form>
	</div>
	<div id="t">
	<div class="title">
