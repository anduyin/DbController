 ...
 *  */
	...
	$query2 = "select * from daily_collection_amount_statistics_cg where date>='$time' and date<='$tenDay' and update_time = '$time'";
...
<body style="background-color:#fff;">
	...
	<div style="text-align: center" class="top">
		...
		<form action="../download.php" method="post">
            ...
            <span style="font-size:18px;color:#F44B2A;float:left;">催收金额预计(存管)</span>
			<!-- 时间选项 -->
			...
			<input type='hidden' name ="tmp" value='E.xlsx'>
		</form>
	</div>
	<div id="t">
		<div class="title">
