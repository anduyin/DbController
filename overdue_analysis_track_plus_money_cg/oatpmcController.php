...
$loan_name  = $_POST[0];
$time = $_POST[2];
$query = "select * from overdue_analysis_track_plus_money_cg where field = \"$field\" and loan_name= \"$loan_name\" and update_time = \"$time\"";
...
for($i=0;$i<count($arr);$i++){
	...
	$arr[$i]['repay_money_proportion'] = number_format((($arr[$i]['repay_money_proportion'])/10000),2,'.','');
}
