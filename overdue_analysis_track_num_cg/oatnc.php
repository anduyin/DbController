 ...
 *  */
	...
	$query2 = "select * from overdue_analysis_track_num_cg where status_time= \"$statusTime\" and field= \"贷款名称\"";
...
<body style="background-color:#fff;">
	...
	<div style="text-align: center" class="top">
		...
		<form action="../download_cg.php" method="post">
			...
			<a href="../overdue_analysis_track_money_cg/oatmc.php" class="href">金额-回溯版(存管)</a>
			<a href="oatncPic.php" class="href">柱形图</a>
		</form>
	</div>
	<div id="t">
		<div class="title">
