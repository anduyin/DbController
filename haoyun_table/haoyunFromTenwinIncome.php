...
$main = new main();
$field = $main->getColumnName($link,'haoyun_from_tenwin_income');
$query = "SELECT {$field} FROM `haoyun_from_tenwin_income` ORDER BY `create_date` DESC ";
$result = mysqli_query($link, $query);
$arr = $result->fetch_all(MYSQLI_ASSOC);
$head = $main->getColumnComment($link,'haoyun_from_tenwin_income');
mysqli_close($link);
...
<div style="text-align: center" class="top">
    ...
    <span style="font-size:18px;color:#F44B2A;float:left;">浩云从腾分期导流的营收</span>
</div>
<div class="search">
...
<script type="text/javascript">
    ...
    $("#download").click(function(){
        ...
        exportPlugin.downloadFile('csv', {filename: '浩云从腾分期导流的营收'});
    })
</script>
</html>