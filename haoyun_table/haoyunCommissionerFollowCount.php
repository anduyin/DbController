...
$main = new main();
$field = $main->getColumnName($link,'haoyun_commissioner_follow_count');
$head = $main->getColumnComment($link,'haoyun_commissioner_follow_count');
$query = "SELECT {$field} FROM `haoyun_commissioner_follow_count` ORDER BY create_date DESC ";
...
<div style="text-align: center" class="top">
    ...
    <span style="font-size:18px;color:#F44B2A;float:left;">各专员跟进数表</span>
</div>
<div class="search">
...
<script type="text/javascript">
    ...
    $("#download").click(function(){
        ...
        exportPlugin.downloadFile('csv', {filename: '各专员跟进数表'});
    })
