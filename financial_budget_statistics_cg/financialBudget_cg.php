...
//获取最大更新时间
$sql = "select update_date from financial_budget_statistics_cg  GROUP by update_date order by update_date DESC ";
...
<body style="background-color:#fff;">
	...
	<div style="text-align: center" class="top">
		...
		<form action="../download.php" method="post">
			...
			<a href="financialBudgetPic_cg.php" class="href">收支预计柱形图(存管)</a>
		</form>
	</div>
	<div id="t">
		<div class="title">
