 ...
 *  */
	...
	$query2 = "select * from overdue_analysis_current_num_tg where status_time= \"$statusTime\" and field= \"贷款名称\"";
...
<body style="background-color:#fff;">
	...
	<div style="text-align: center" class="top">
		...
		<form action="../download.php" method="post">
			...
			<a href="../overdue_analysis_current_money/oacm.php" class="href">金额-现状版</a>
			<a href="oacnPic1.php" class="href">笔数柱形图</a>
			<a href="oacnPic2.php" class="href">逾期率柱形图</a>
		</form>
	</div>
	<div id="t">
		<div class="title">
