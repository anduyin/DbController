...
$query = "SELECT * FROM `licai_monthly_notrepay` ORDER BY give_month DESC ";
$result = mysqli_query($link, $query);
$arr = $result->fetch_all(MYSQLI_ASSOC);
mysqli_close($link);
$head = array('ID','月份','托管待收金额','托管待收笔数','托管待收人数','存管待收金额','存管待收笔数','存管待收人数');
...
<body style="background-color:#fff;">
	...
	<div style="text-align: center" class="top">
        ...
        <span style="font-size:18px;color:#F44B2A;float:left;">月末的平台待收</span>
    </div>
		<div class="search">
...
var hot = new Handsontable(container, {
	...
	$("#download").click(function(){
		...
		exportPlugin.downloadFile('csv', {filename: '月末的平台待收'});
	})
</script>
</script>
</html>
