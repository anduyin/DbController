 ...
 *  */
	...
	$query = "SELECT date,type,num,money FROM `repayment_type_statistics_tg` where date >=".'\''.$start.'\''." and date <=".'\''.$now.'\''." and type = '用户还款' order by date desc limit " .$index.','.$pageSize;//首次打开,显示30条
	echo $query;
