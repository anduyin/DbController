 ...
 *  */
	...
	$query2 = "select * from daily_repay_money_deal_loan_cg order by id desc";
...
<body style="background-color:#fff;">
	...
	<div style="text-align: center" class="top">
		...
		<form action="../download_cg.php" method="post">
            ...
            <span style="font-size:18px;color:#F44B2A;float:left;">每日待收金额(存管)</span>	
			<!-- 时间选项 -->
			...
			<a href="drmdlcPic.php" class="href">每日待收金额(存管)柱形图</a>
		</form>
	</div>
	<div id="t">
		<div class="title">
