...
mysqli_close($link);
$head = array('ID','注册月份','推荐人','注册渠道','注册人数','实名人数','注册当天充值人数','注册当天充值金额','注册当天投资人数','注册当天投资金额','注册当天投资笔数','注册30天内充值人数','注册30天内充值金额','注册30天内投资人数','注册30天内投资金额','注册30天内投资笔数');
...
<body style="background-color:#fff;">
	...
	<div style="text-align: center" class="top">
        ...
        <span style="font-size:18px;color:#F44B2A;float:left;">当月注册用户转化效率</span>
    </div>
		<div class="search">
...
var hot = new Handsontable(container, {
	...
	$("#download").click(function(){
		...
		exportPlugin.downloadFile('csv', {filename: '当月注册用户转化效率'});
	})
</script>
</script>
</html>
