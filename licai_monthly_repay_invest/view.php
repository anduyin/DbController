...
$query = "SELECT * FROM `licai_monthly_repay_invest` ORDER BY repay_month DESC ";
$result = mysqli_query($link, $query);
$arr = $result->fetch_all(MYSQLI_ASSOC);
mysqli_close($link);
$head = array('ID','回款月份','回款金额','回款人数','回款笔数','当天投资金额','当天投资人数','当天投资笔数','当天提现金额','当天提现人数','当天提现笔数');
...
<body style="background-color:#fff;">
	...
	<div style="text-align: center" class="top">
        ...
        <span style="font-size:18px;color:#F44B2A;float:left;">回款复投人数</span>
    </div>
		<div class="search">
...
var hot = new Handsontable(container, {
	...
	$("#download").click(function(){
		...
		exportPlugin.downloadFile('csv', {filename: '回款复投人数'});
	})
</script>
</script>
</html>
