...
$main = new main();
$field = $main->getColumnName($link,'xssd_assets_state_statistics');
$query = "SELECT {$field} FROM `xssd_assets_state_statistics` ORDER BY `date` DESC ";
$result = mysqli_query($link, $query);
$arr = $result->fetch_all(MYSQLI_ASSOC);
$head = $main->getColumnComment($link,'xssd_assets_state_statistics');
mysqli_close($link);
...
<div style="text-align: center" class="top">
    ...
    <span style="font-size:18px;color:#F44B2A;float:left;">每日上标放款量</span>
</div>
<div class="search">
...
<script type="text/javascript">
    ...
    $("#download").click(function(){
        ...
        exportPlugin.downloadFile('csv', {filename: '每日上标放款量'});
    })
</script>
</html>