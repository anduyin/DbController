...
$query = "SELECT create_date,login,login_except_register,register,borrow FROM `tenwin_cg_register_login_borrow_count` ORDER BY create_date DESC ";
$result = mysqli_query($link, $query);
$arr = $result->fetch_all(MYSQLI_ASSOC);
$q = "SELECT COLUMN_COMMENT FROM information_schema.COLUMNS WHERE TABLE_NAME = 'tenwin_cg_register_login_borrow_count'";
